...
if(NETCDF_NC4)
  macro(NetCDF_check_feature feature_name)
    ...
    if(NC_CONFIG STREQUAL "NC_CONFIG-NOTFOUND")
      message(STATUS "Couldn't find nc-config to determine netcdf capabilities")
    else()
  ...
  if(NOT NETCDF_HAS_nc4)
    message(STATUS "NetCDF not compiled with v4 support")
  else()
